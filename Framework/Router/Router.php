...
use Henri\Framework\Router\Event\OnBeforeRoutesCompileEvent;
...
class Router implements RouterInterface {
     ...
     */
    public function __construct( Harvester $harvester, HTTPRequest $HTTPRequest, Configuration $configuration, EventDispatcher $eventDispatcher) {
